...
(library Library_1
	...
	(compDef "IIS2MDCTR" (originalName "IIS2MDCTR") (compHeader (numPins 12) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "INT/DRDY") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "10" (pinName "VDD_IO") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.st.com/resource/en/datasheet/iis2mdc.pdf")
		(attr "Height" "0.7 mm")
	)
